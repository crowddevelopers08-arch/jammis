      ...
      <div style={{
        ...
        >
            ...
            {duplicatedImages.map((image, index) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: '1rem',
                  overflow: 'hidden',
                  boxShadow: '0 6px 20px rgba(83, 13, 60, 0.15)',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 12px 30px rgba(83, 13, 60, 0.25)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'scale(1)';
                  e.currentTarget.style.boxShadow = '0 6px 20px rgba(83, 13, 60, 0.15)';
                }}
                onClick={togglePause}
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.style.backgroundColor = '#530d3c';
                    target.style.display = 'flex';
                    target.style.alignItems = 'center';
                    target.style.justifyContent = 'center';
                    target.style.color = '#fcb716';
          ...
          <div style={{
            ...
            bottom: 0,
            width: '120px',
            background: 'linear-gradient(90deg, #f3f3f3 0%, transparent 100%)',
            pointerEvents: 'none'
          }} />
          <div style={{
            position: 'absolute',
            ...
            bottom: 0,
            width: '120px',
            background: 'linear-gradient(270deg, #f3f3f3 0%, transparent 100%)',
            pointerEvents: 'none'
          }} />
        </div>
